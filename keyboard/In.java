 ...
 */
package fr.plaglefleau.translate.keyboard;
...
/**
 * Cette classe recupere les touches saisies au keyboard Chaque methode retourne
 * les informations saisies au keyboard dans le format desire<br>.
 * <hr>
...
public class In {
    ...
    /*
	 * @param in 
	 * c'est une reference sur le flux du keyboard
     */
     ...
     * sous forme d'entier
     * @exception IOException : probleme avec le keyboard, declaration
     * @return un entier qui correspond à la valeur tapee sur le keyboard
     * @exception NumberFormatException si la valeur saisie n'est pas un entier
     */
    public static int readInteger() {
        /*
		 * mot stocke les touches tapees au keyboard
		 * jusqu'a ce que l'utilisateur appuie sur 
		 * la touche entree du keyboard
         */
        String mot = null;        
        do {
            try {
			 ...
			 * Si des touches ont ete appuyees
                ...
                System.out.println("Erreur de lecture du keyboard " + e);
            }
        } while (1 == 1);    
    }
     ...
     * sous forme d'entier
     *
     * @return un entier qui correspond a la valeur tapee sur le keyboard
     * @exception IOException : probleme avec le keyboard, declaration
     * @exception NumberFormatException si la valeur saisie n'est pas un entier
     */
     ...
     *
     * @return un double qui correspond a la valeur tapee sur le keyboard
     * @exception IOException : probleme avec le keyboard, declaration
     * obligatoire en java
     ...
     *
     * @return un flottant qui correspond a la valeur tapee sur le keyboard
     * @exception IOException : probleme avec le keyboard, declaration
     * obligatoire en java
    ...
    public static String readString() //throws Exception
    {
        ...
        try {
            /*
			 * Retourne directemet les touches tapees au keyboard
            ...
            System.out.println("Erreur de lecture de keyboard " + e);
        }
        return null;
    }
     ...
     *
     * @return un caratere qui correspond a la valeur tapee sur le keyboard
     * @exception IOException : probleme avec le keyboard, declaration
     * @exception NumberFormatException si la valeur saisie n'est pas un
     * caratere
     */
    public static char readChar() //throws Exception
    {
        ...
        try {
            ...
            /*
			 * Si la valeur saisie au keyboard n'est pas un char,
    ...
    public static char[] readArrayChar()// throws Exception
    {
        ...
        try {
            ...
            /*
			 * Si la valeur saisie au keyboard n'est pas un byte,
			 * je passe dans ce code
             */
            System.out.println("Vous n'avez pas saisi un entier ");
        }
